========================================================================
    KONSOLENANWENDUNG: Test_Dll_Cpp-Projektübersicht
========================================================================

Diese Test_Dll_Cpp-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Test_Dll_Cpp-Anwendung besteht.


Test_Dll_Cpp.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Test_Dll_Cpp.pch und eine 
